data {
  ...
  array[num_data] int node_id;                                 // Node IDs per window
...
transformed parameters {
  ...
  for(i in 1:num_nodes_window8) {
    predictor_window8[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[8])] + window_random_effect[8] + node_random_effect[node_id[(i + num_nodes_prev_windows[8])]];
  }
  vector[num_nodes_window9] predictor_window9;
  for(i in 1:num_nodes_window9) {
    predictor_window9[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[9])] + window_random_effect[9] + node_random_effect[node_id[(i + num_nodes_prev_windows[9])]];
  }
  vector[num_nodes_window10] predictor_window10;
  for(i in 1:num_nodes_window10) {
    predictor_window10[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[10])] + window_random_effect[10] + node_random_effect[node_id[(i + num_nodes_prev_windows[10])]];
  }
  vector[num_nodes_window11] predictor_window11;
  for(i in 1:num_nodes_window11) {
    predictor_window11[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[11])] + window_random_effect[11] + node_random_effect[node_id[(i + num_nodes_prev_windows[11])]];
  }
  vector[num_nodes_window12] predictor_window12;
  for(i in 1:num_nodes_window12) {
    predictor_window12[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[12])] + window_random_effect[12] + node_random_effect[node_id[(i + num_nodes_prev_windows[12])]];
  }
  vector[num_nodes_window13] predictor_window13;
  for(i in 1:num_nodes_window13) {
    predictor_window13[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[13])] + window_random_effect[13] + node_random_effect[node_id[(i + num_nodes_prev_windows[13])]];
  }
  vector[num_nodes_window14] predictor_window14;
  for(i in 1:num_nodes_window14) {
    predictor_window14[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[14])] + window_random_effect[14] + node_random_effect[node_id[(i + num_nodes_prev_windows[14])]];
  }
  vector[num_nodes_window15] predictor_window15;
  for(i in 1:num_nodes_window15) {
    predictor_window15[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[15])] + window_random_effect[15] + node_random_effect[node_id[(i + num_nodes_prev_windows[15])]];
  }
  vector[num_nodes_window16] predictor_window16;
  for(i in 1:num_nodes_window16) {
    predictor_window16[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[16])] + window_random_effect[16] + node_random_effect[node_id[(i + num_nodes_prev_windows[16])]];
  }
  vector[num_nodes_window17] predictor_window17;
  for(i in 1:num_nodes_window17) {
    predictor_window17[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[17])] + window_random_effect[17] + node_random_effect[node_id[(i + num_nodes_prev_windows[17])]];
  }
  vector[num_nodes_window18] predictor_window18;
  for(i in 1:num_nodes_window18) {
    predictor_window18[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[18])] + window_random_effect[18] + node_random_effect[node_id[(i + num_nodes_prev_windows[18])]];
  }
  vector[num_nodes_window19] predictor_window19;
  for(i in 1:num_nodes_window19) {
    predictor_window19[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[19])] + window_random_effect[19] + node_random_effect[node_id[(i + num_nodes_prev_windows[19])]];
  }
  vector[num_nodes_window20] predictor_window20;
  for(i in 1:num_nodes_window20) {
    predictor_window20[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[20])] + window_random_effect[20] + node_random_effect[node_id[(i + num_nodes_prev_windows[20])]];
  }
  vector[num_nodes_window21] predictor_window21;
  for(i in 1:num_nodes_window21) {
    predictor_window21[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[21])] + window_random_effect[21] + node_random_effect[node_id[(i + num_nodes_prev_windows[21])]];
  }
  vector[num_nodes_window22] predictor_window22;
  for(i in 1:num_nodes_window22) {
    predictor_window22[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[22])] + window_random_effect[22] + node_random_effect[node_id[(i + num_nodes_prev_windows[22])]];
  }
  vector[num_nodes_window23] predictor_window23;
  for(i in 1:num_nodes_window23) {
    predictor_window23[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[23])] + window_random_effect[23] + node_random_effect[node_id[(i + num_nodes_prev_windows[23])]];
  }
  vector[num_nodes_window24] predictor_window24;
  for(i in 1:num_nodes_window24) {
    predictor_window24[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[24])] + window_random_effect[24] + node_random_effect[node_id[(i + num_nodes_prev_windows[24])]];
  }
  vector[num_nodes_window25] predictor_window25;
  for(i in 1:num_nodes_window25) {
    predictor_window25[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[25])] + window_random_effect[25] + node_random_effect[node_id[(i + num_nodes_prev_windows[25])]];
  }
  vector[num_nodes_window26] predictor_window26;
  for(i in 1:num_nodes_window26) {
    predictor_window26[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[26])] + window_random_effect[26] + node_random_effect[node_id[(i + num_nodes_prev_windows[26])]];
  }
  vector[num_nodes_window27] predictor_window27;
  for(i in 1:num_nodes_window27) {
    predictor_window27[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[27])] + window_random_effect[27] + node_random_effect[node_id[(i + num_nodes_prev_windows[27])]];
  }
  vector[num_nodes_window28] predictor_window28;
  for(i in 1:num_nodes_window28) {
    predictor_window28[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[28])] + window_random_effect[28] + node_random_effect[node_id[(i + num_nodes_prev_windows[28])]];
  }
  vector[num_nodes_window29] predictor_window29;
  for(i in 1:num_nodes_window29) {
    predictor_window29[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[29])] + window_random_effect[29] + node_random_effect[node_id[(i + num_nodes_prev_windows[29])]];
  }
  vector[num_nodes_window30] predictor_window30;
  for(i in 1:num_nodes_window30) {
    predictor_window30[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[30])] + window_random_effect[30] + node_random_effect[node_id[(i + num_nodes_prev_windows[30])]];
  }
  vector[num_nodes_window31] predictor_window31;
  for(i in 1:num_nodes_window31) {
    predictor_window31[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[31])] + window_random_effect[31] + node_random_effect[node_id[(i + num_nodes_prev_windows[31])]];
  }
  vector[num_nodes_window32] predictor_window32;
  for(i in 1:num_nodes_window32) {
    predictor_window32[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[32])] + window_random_effect[32] + node_random_effect[node_id[(i + num_nodes_prev_windows[32])]];
  }
  vector[num_nodes_window33] predictor_window33;
  for(i in 1:num_nodes_window33) {
    predictor_window33[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[33])] + window_random_effect[33] + node_random_effect[node_id[(i + num_nodes_prev_windows[33])]];
  }
  vector[num_nodes_window34] predictor_window34;
  for(i in 1:num_nodes_window34) {
    predictor_window34[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[34])] + window_random_effect[34] + node_random_effect[node_id[(i + num_nodes_prev_windows[34])]];
  }
  vector[num_nodes_window35] predictor_window35;
  for(i in 1:num_nodes_window35) {
    predictor_window35[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[35])] + window_random_effect[35] + node_random_effect[node_id[(i + num_nodes_prev_windows[35])]];
  }
  vector[num_nodes_window36] predictor_window36;
  for(i in 1:num_nodes_window36) {
    predictor_window36[i] = intercept + beta_age * node_age[(i + num_nodes_prev_windows[36])] + window_random_effect[36] + node_random_effect[node_id[(i + num_nodes_prev_windows[36])]];
  }
...
model {
  // priors
  intercept ~ normal(logit(0.05),1); // 0.05 best estimate of intercept for Amboseli population eigen ~ age (edge weights from half weight index) from Chiyo 2011 -- estimated intercept from figure. Logit because on 0-1 scale 
