...
### nodes data frame
ele_nodes <- read_delim('../data_processed/motnp_id.csv', delim = ',')  # read in ID data
...
eles_long <- read_delim('../data_processed/motnp_eles_long.csv', delim = ',')  # read in individual sightings data
...
write_delim(gbi_df, '../data_processed/motnp_bayesian_bernoullipairwiseevents.csv', delim = ',')
...
### write csv
readr::write_delim(dyads, '../data_processed/motnp_bayesian_binomialpairwiseevents.csv', delim = ',') # write to file
