...
priors$fixed <- 'normal(0, 1)'  # slightly less wide than before, but zero-centered so allows age to have a positive or negative impact on centrality and edge weight
