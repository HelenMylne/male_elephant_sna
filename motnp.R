...
d$gps_s <- as.numeric(d$gps_s)
d$gps_e <- as.numeric(d$gps_e)
...
eles_long <- read_csv2('data_processed/motnp_eles_long.csv')
...
ele_links$days1  <- as.numeric(ele_links$days1)
ele_links$days2  <- as.numeric(ele_links$days2)
