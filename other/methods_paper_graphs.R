...
set_cmdstan_path('../packages/.cmdstan/cmdstan-2.34.1')
...
ggsave(filename = 'priors_sri.png',
       ...
       plot = priors_sri, device = 'png', width = 1400, height = 800, units = 'px')
...
ggsave(filename = 'priors_default.png',
       path = '../outputs/sparse_network_methods_figures/',
       plot = priors_default, device = 'png', width = 1400, height = 800, units = 'px')
...
ggsave(filename = 'priors_skewed.png',
       path = '../outputs/sparse_network_methods_figures/',
       plot = priors_skewed, device = 'png', width = 1400, height = 800, units = 'px')
...
ggsave(filename = 'prior_conditional.png',
       path = '../outputs/sparse_network_methods_figures/',
       plot = prior_conditional, device = 'png', width = 1000, height = 800, units = 'px')
...
ggsave(filename = 'edges_sri.png',
       path = '../outputs/sparse_network_methods_figures/',
       plot = edges_sri, device = 'png', width = 1400, height = 800, units = 'px')
...
ggsave(filename = 'edgesightings_sri_noline.png',
       path = '../outputs/sparse_network_methods_figures/',
       plot = edgesightings_sri.1, device = 'png', width = 1400, height = 800, units = 'px')
...
ggsave(filename = 'edgesightings_sri_withline_changealpha.png',
       path = '../outputs/sparse_network_methods_figures/',
       plot = edgesightings_sri.2, device = 'png', width = 1400, height = 800, units = 'px')
...
ggsave(filename = 'edgesightings_sri_withline_changesize.png',
       path = '../outputs/sparse_network_methods_figures/',
       plot = edgesightings_sri.3, device = 'png', width = 1400, height = 800, units = 'px')
...
rm(counts_ls_uniform, edge_binary_uniform, edge_samples1, edges, edges_subset, averages) ; gc()
...
rm(counts_ls_default, edge_binary_default, edge_samples1, edges, edges_subset, averages) ; gc()
...
(figure_skewed_edgesightings.2 <- ggplot(averages, aes(x = count_dyad, y = median))+
    geom_point(colour = rgb(33/255, 145/255, 140/255, 0.1),
               size = 0.5,
               shape = 19)+
    geom_smooth(colour = rgb(68/255, 1/255, 84/255))+
...
rm(list = ls()[ !ls() %in% c('posterior_conditional.2','edgesightings_conditional.3')])
...
ggsave(filename = 'eigen_outputs_unconditional.png',
       path = '../outputs/sparse_network_methods_figures/',
       plot = last_plot(), device = 'png', width = 2100, height = 1600, units = 'px')
