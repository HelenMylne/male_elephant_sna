...
library(cmdstanr) # library(cmdstanr, lib.loc = '../packages/')
library(tidyverse)
...
# clean up 
rm(list = ls()[!ls() %in% c('edgesightings_sri.3', 'counts_df')]) ; gc()
...
(edgesightings_conditional.1 <- ggplot(means, aes(x = count_dyad, y = mean))+
    geom_point(colour = rgb(33/255, 145/255, 140/255, 0.1), size = 0.5, shape = 19)+
    scale_x_continuous(name = 'total dyad sightings')+
    scale_y_continuous(name = 'mean weight', limits = c(-0.02,1.02), expand = c(0,0))
)
...
(edgesightings_conditional.2 <- ggplot(means, aes(x = count_dyad, y = mean))+
    geom_point(colour = rgb(33/255, 145/255, 140/255, 0.1), size = 0.5, shape = 19)+
    geom_smooth(colour = rgb(68/255, 1/255, 84/255))+
    scale_x_continuous(name = 'total dyad sightings')+
    scale_y_continuous(name = 'mean weight', limits = c(-0.02,1.02), expand = c(0,0))
