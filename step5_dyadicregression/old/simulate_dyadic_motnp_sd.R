...
#   y <- rep(NA, length(x))
#   for(j in 1:length(x)){
#     y[j] <- intercept[i] + beta_age_min[i]*sum(min_dirichlet[i,][1:x[j]]) + beta_age_max[i]*sum(max_dirichlet[i,][1:x[j]]) + mm_nodes[i]
#   }
#   lines(x = x, y = y, col = rgb(0,0,1,0.4))
# }
# rm(n, beta_age_max, beta_age_min, intercept, min_dirichlet, max_dirichlet, i, y, j, x, mm_nodes) ; gc()
# 
# ## print progress marker
...
# 
# ## save output
# save.image('step5_dyadicregression/motnp_dyadic_simulation_sd.RData')
# 
# ## load dyadic regression model
# dyadic_regression <- stan_model('models/dyadic_regression_motnp_sd.stan')
...
# #### check outputs ####
# dev.off()
# pdf('step5_dyadicregression/simulate_dyadic_sd_motnp_checkoutputs.pdf')
# #load('step5_dyadicregression/motnp_dyadic_simulation_sd.RData')
# 
# ## extract draws
...
# pdf('step5_dyadicregression/simulate_dyadic_sd_motnp_predictions.pdf')
# load('step5_dyadicregression/motnp_dyadic_simulation_sd.RData')
# 
...
#   group_by(age_cat_min, age_cat_max) %>%
...
#   ungroup() %>%
#   select(age_cat_min, age_cat_max,
...
# load('step5_dyadicregression/motnp_dyadic_simulation_sd.RData')
# pdf('step5_dyadicregression/simulate_dyadic_sd_motnp_contrasts.pdf')
# 
...
# # pred_new11 <- pred_new %>%
# #   mutate(age_cat_1_alt   = '10-15', age_cat_2_alt   = '10-15', age_num_1_alt   = 1, age_num_2_alt   = 1,
# #          age_cat_min_alt = '10-15', age_cat_max_alt = '10-15', age_num_min_alt = 1, age_num_max_alt = 1)
# # pred_new12 <- pred_new %>%
# #   mutate(age_cat_1_alt   = '10-15', age_cat_2_alt   = '15-19', age_num_1_alt   = 1, age_num_2_alt   = 2,
# #          age_cat_min_alt = '10-15', age_cat_max_alt = '15-19', age_num_min_alt = 1, age_num_max_alt = 2)
# # pred_new13 <- pred_new %>%
# #   mutate(age_cat_1_alt   = '10-15', age_cat_2_alt   = '20-25', age_num_1_alt   = 1, age_num_2_alt   = 3,
# #          age_cat_min_alt = '10-15', age_cat_max_alt = '20-25', age_num_min_alt = 1, age_num_max_alt = 3)
# # pred_new14 <- pred_new %>%
# #   mutate(age_cat_1_alt   = '10-15', age_cat_2_alt   = '25-40', age_num_1_alt   = 1, age_num_2_alt   = 4,
# #          age_cat_min_alt = '10-15', age_cat_max_alt = '25-40', age_num_min_alt = 1, age_num_max_alt = 4)
# # pred_new15 <- pred_new %>%
# #   mutate(age_cat_1_alt   = '10-15', age_cat_2_alt   = '40+',   age_num_1_alt   = 1, age_num_2_alt   = 5,
# #          age_cat_min_alt = '10-15', age_cat_max_alt = '40+',   age_num_min_alt = 1, age_num_max_alt = 5)
# #
# # pred_new22 <- pred_new %>%
# #   mutate(age_cat_1_alt   = '15-19', age_cat_2_alt   = '15-19', age_num_1_alt   = 2, age_num_2_alt   = 2,
# #          age_cat_min_alt = '15-19', age_cat_max_alt = '15-19', age_num_min_alt = 2, age_num_max_alt = 2)
# # pred_new23 <- pred_new %>%
# #   mutate(age_cat_1_alt   = '15-19', age_cat_2_alt   = '20-25', age_num_1_alt   = 2, age_num_2_alt   = 3,
# #          age_cat_min_alt = '15-19', age_cat_max_alt = '20-25', age_num_min_alt = 2, age_num_max_alt = 3)
# # pred_new24 <- pred_new %>%
# #   mutate(age_cat_1_alt   = '15-19', age_cat_2_alt   = '25-40', age_num_1_alt   = 2, age_num_2_alt   = 4,
# #          age_cat_min_alt = '15-19', age_cat_max_alt = '25-40', age_num_min_alt = 2, age_num_max_alt = 4)
# # pred_new25 <- pred_new %>%
# #   mutate(age_cat_1_alt   = '15-19', age_cat_2_alt   = '40+',   age_num_1_alt   = 2, age_num_2_alt   = 5,
# #          age_cat_min_alt = '15-19', age_cat_max_alt = '40+',   age_num_min_alt = 2, age_num_max_alt = 5)
# #
# # pred_new33 <- pred_new %>%
# #   mutate(age_cat_1_alt   = '20-25', age_cat_2_alt   = '20-25', age_num_1_alt   = 3, age_num_2_alt   = 3,
# #          age_cat_min_alt = '20-25', age_cat_max_alt = '20-25', age_num_min_alt = 3, age_num_max_alt = 3)
# # pred_new34 <- pred_new %>%
# #   mutate(age_cat_1_alt   = '20-25', age_cat_2_alt   = '25-40', age_num_1_alt   = 3, age_num_2_alt   = 4,
# #          age_cat_min_alt = '20-25', age_cat_max_alt = '25-40', age_num_min_alt = 3, age_num_max_alt = 4)
# # pred_new35 <- pred_new %>%
# #   mutate(age_cat_1_alt   = '20-25', age_cat_2_alt   = '40+',   age_num_1_alt   = 3, age_num_2_alt   = 5,
# #          age_cat_min_alt = '20-25', age_cat_max_alt = '40+',   age_num_min_alt = 3, age_num_max_alt = 5)
# #
# # pred_new44 <- pred_new %>%
# #   mutate(age_cat_1_alt   = '25-40', age_cat_2_alt   = '25-40', age_num_1_alt   = 4, age_num_2_alt   = 4,
# #          age_cat_min_alt = '25-40', age_cat_max_alt = '25-40', age_num_min_alt = 4, age_num_max_alt = 4)
# # pred_new45 <- pred_new %>%
# #   mutate(age_cat_1_alt   = '25-40', age_cat_2_alt   = '40+',   age_num_1_alt   = 4, age_num_2_alt   = 5,
# #          age_cat_min_alt = '25-40', age_cat_max_alt = '40+',   age_num_min_alt = 4, age_num_max_alt = 5)
# #
# # pred_new55 <- pred_new %>%
# #   mutate(age_cat_1_alt   = '40+',   age_cat_2_alt   = '40+',   age_num_1_alt   = 5, age_num_2_alt   = 5,
# #          age_cat_min_alt = '40+',   age_cat_max_alt = '40+',   age_num_min_alt = 5, age_num_max_alt = 5)
# 
...
#       mu[draw, dyad] <- intercept[draw] + b_min[draw]*sum(delta_j_min[draw,(1:prediction_df$age_num_min[dyad])]) + b_max[draw]*sum(delta_j_max[draw,(1:prediction_df$age_num_max[dyad])]) + node_effects[draw]
#     }
#   }
#   return(mu)
#   }
...
# for(i in c(#11:15,22:25,33:35,
#            44:45,55)){
#   ## create data frame to predict from
#   pred_new_age <- pred_new %>%
#     mutate(age_cat_1   = ifelse(i %in% c(11,12,13,14,15), '10-15',
#                                 ifelse(i %in% c(22,23,24,25), '15-19',
#                                        ifelse(i %in% c(33,34,35), '20-25',
#                                               ifelse(i %in% c(44,45), '25-40',
#                                                      '40+')))),
#            age_cat_2   = ifelse(i %in% c(11), '10-15',
#                                 ifelse(i %in% c(12,22), '15-19',
#                                        ifelse(i %in% c(13,23,33), '20-25',
#                                               ifelse(i %in% c(14,24,34,44), '25-40',
#                                                      '40+')))),
#            age_num_1   = ifelse(i %in% c(11,12,13,14,15), 1,
#                                 ifelse(i %in% c(22,23,24,25), 2,
#                                        ifelse(i %in% c(33,34,35), 3,
#                                               ifelse(i %in% c(44,45), 4,
#                                                      5)))),
#            age_num_2   = ifelse(i %in% c(11), 1,
#                                 ifelse(i %in% c(12,22), 2,
#                                        ifelse(i %in% c(13,23,33), 3,
#                                               ifelse(i %in% c(14,24,34,44), 4,
#                                                      5))))) %>%
#     mutate(age_cat_min = NA, age_cat_max = NA,
#            age_num_min = NA, age_num_max = NA)
#   for(j in 1:nrow(pred_new_age)){
#     pred_new_age$age_num_min[j] <- min(c(pred_new_age$age_num_1[j],
#                                          pred_new_age$age_num_2[j]))
#     pred_new_age$age_num_max[j] <- max(c(pred_new_age$age_num_1[j],
#                                          pred_new_age$age_num_2[j]))
#     pred_new_age$age_cat_min[j] <- ifelse(pred_new_age$age_num_min[j] == 1, '10-15',
#                                           ifelse(pred_new_age$age_num_min[j] == 2, '15-19',
#                                                  ifelse(pred_new_age$age_num_min[j] == 3, '20-25',
#                                                         ifelse(pred_new_age$age_num_min[j] == 4, '25-40',
#                                                                '40+'))))
#     pred_new_age$age_cat_max[j] <- ifelse(pred_new_age$age_num_max[j] == 1, '10-15',
#                                           ifelse(pred_new_age$age_num_max[j] == 2, '15-19',
#                                                  ifelse(pred_new_age$age_num_max[j] == 3, '20-25',
#                                                         ifelse(pred_new_age$age_num_max[j] == 4, '25-40',
#                                                                '40+'))))
#   }
# 
...
#           file = paste0('../data_processed/step5_dyadicregression/simulate_motnp_meanpredictions_agecombo',i,'.RDS'))
#   saveRDS(object = as.data.frame(predictions_full[[i]]),
#           file = paste0('../data_processed/step5_dyadicregression/simulate_motnp_fullpredictions_agecombo',i,'.RDS'))
# }
# 
# ## if image does not write properly, will need to rebuild lists from written predictions
# predictions_mean <- list()
# predictions_full <- list()
# for(i in c(11:15,22:25,33:35,44:45,55)){
#   ## save outputs in case R crashes
...
# print('predictions complete')
# 
# # ## calculate mean predictions for each age combination
# # predictions_mu_11 <- get_mean_predictions(prediction_df = pred_new11)
# # predictions_mu_12 <- get_mean_predictions(prediction_df = pred_new12)
# # predictions_mu_13 <- get_mean_predictions(prediction_df = pred_new13)
# # predictions_mu_14 <- get_mean_predictions(prediction_df = pred_new14)
# # predictions_mu_15 <- get_mean_predictions(prediction_df = pred_new15)
# # predictions_mu_22 <- get_mean_predictions(prediction_df = pred_new22)
# # predictions_mu_23 <- get_mean_predictions(prediction_df = pred_new23)
# # predictions_mu_24 <- get_mean_predictions(prediction_df = pred_new24)
# # predictions_mu_25 <- get_mean_predictions(prediction_df = pred_new25)
# # predictions_mu_33 <- get_mean_predictions(prediction_df = pred_new33)
# # predictions_mu_34 <- get_mean_predictions(prediction_df = pred_new34)
# # predictions_mu_35 <- get_mean_predictions(prediction_df = pred_new35)
# # predictions_mu_44 <- get_mean_predictions(prediction_df = pred_new44)
# # predictions_mu_45 <- get_mean_predictions(prediction_df = pred_new45)
# # predictions_mu_55 <- get_mean_predictions(prediction_df = pred_new55)
# # 
# # ## calculate full predictions
# # predictions_full_11 <- get_full_predictions(mu_matrix = predictions_mu_11,
# #                                             sigma = posterior_samples$sigma )
# # predictions_full_12 <- get_full_predictions(mu_matrix = predictions_mu_12,
# #                                             sigma = posterior_samples$sigma )
# # predictions_full_13 <- get_full_predictions(mu_matrix = predictions_mu_13,
# #                                             sigma = posterior_samples$sigma )
# # predictions_full_14 <- get_full_predictions(mu_matrix = predictions_mu_14,
# #                                             sigma = posterior_samples$sigma )
# # predictions_full_15 <- get_full_predictions(mu_matrix = predictions_mu_15,
# #                                             sigma = posterior_samples$sigma )
# # predictions_full_22 <- get_full_predictions(mu_matrix = predictions_mu_22,
# #                                             sigma = posterior_samples$sigma )
# # predictions_full_23 <- get_full_predictions(mu_matrix = predictions_mu_23,
# #                                             sigma = posterior_samples$sigma )
# # predictions_full_24 <- get_full_predictions(mu_matrix = predictions_mu_24,
# #                                             sigma = posterior_samples$sigma )
# # predictions_full_25 <- get_full_predictions(mu_matrix = predictions_mu_25,
# #                                             sigma = posterior_samples$sigma )
# # predictions_full_33 <- get_full_predictions(mu_matrix = predictions_mu_33,
# #                                             sigma = posterior_samples$sigma )
# # predictions_full_34 <- get_full_predictions(mu_matrix = predictions_mu_34,
# #                                             sigma = posterior_samples$sigma )
# # predictions_full_35 <- get_full_predictions(mu_matrix = predictions_mu_35,
# #                                             sigma = posterior_samples$sigma )
# # predictions_full_44 <- get_full_predictions(mu_matrix = predictions_mu_44,
# #                                             sigma = posterior_samples$sigma )
# # predictions_full_45 <- get_full_predictions(mu_matrix = predictions_mu_45,
# #                                             sigma = posterior_samples$sigma )
# # predictions_full_55 <- get_full_predictions(mu_matrix = predictions_mu_55,
# #                                             sigma = posterior_samples$sigma )
# # 
# # ## calculate contrasts
# # contrasts_11vs12 <- predictions_full_12 - predictions_full_11
# # contrasts_11vs13 <- predictions_full_13 - predictions_full_11
# # contrasts_11vs14 <- predictions_full_14 - predictions_full_11
# # contrasts_11vs15 <- predictions_full_15 - predictions_full_11
# # contrasts_12vs13 <- predictions_full_13 - predictions_full_12
# # contrasts_12vs14 <- predictions_full_14 - predictions_full_12
# # contrasts_12vs15 <- predictions_full_15 - predictions_full_12
# # contrasts_13vs14 <- predictions_full_14 - predictions_full_13
# # contrasts_13vs15 <- predictions_full_15 - predictions_full_13
# # contrasts_14vs15 <- predictions_full_15 - predictions_full_14
# # 
# # contrasts_22vs23 <- predictions_full_23 - predictions_full_22
# # contrasts_22vs24 <- predictions_full_24 - predictions_full_22
# # contrasts_22vs25 <- predictions_full_25 - predictions_full_22
# # contrasts_23vs24 <- predictions_full_24 - predictions_full_23
# # contrasts_23vs25 <- predictions_full_25 - predictions_full_23
# # contrasts_24vs25 <- predictions_full_25 - predictions_full_24
# # 
# # contrasts_33vs34 <- predictions_full_34 - predictions_full_33
# # contrasts_33vs35 <- predictions_full_35 - predictions_full_33
# # contrasts_34vs35 <- predictions_full_35 - predictions_full_34
# # 
# # contrasts_44vs45 <- predictions_full_45 - predictions_full_44
# # 
# # contrasts_12vs22 <- predictions_full_22 - predictions_full_12
# # 
# # contrasts_13vs23 <- predictions_full_23 - predictions_full_23
# # contrasts_13vs33 <- predictions_full_33 - predictions_full_13
# # contrasts_23vs33 <- predictions_full_33 - predictions_full_23
# # 
# # contrasts_14vs24 <- predictions_full_24 - predictions_full_14
# # contrasts_14vs34 <- predictions_full_34 - predictions_full_14
# # contrasts_14vs44 <- predictions_full_44 - predictions_full_14
# # contrasts_24vs34 <- predictions_full_34 - predictions_full_24
# # contrasts_24vs44 <- predictions_full_44 - predictions_full_24
# # contrasts_34vs44 <- predictions_full_44 - predictions_full_34
# # 
# # contrasts_15vs25 <- predictions_full_25 - predictions_full_15
# # contrasts_15vs35 <- predictions_full_35 - predictions_full_15
# # contrasts_15vs45 <- predictions_full_45 - predictions_full_15
# # contrasts_15vs55 <- predictions_full_55 - predictions_full_15
# # contrasts_25vs35 <- predictions_full_35 - predictions_full_25
# # contrasts_25vs45 <- predictions_full_45 - predictions_full_25
# # contrasts_25vs55 <- predictions_full_55 - predictions_full_25
# # contrasts_35vs45 <- predictions_full_45 - predictions_full_35
# # contrasts_35vs55 <- predictions_full_55 - predictions_full_35
# # contrasts_45vs55 <- predictions_full_55 - predictions_full_45
# 

load('step5_dyadicregression/motnp_dyadic_simulation_sd.RData')

## create data frame to summarise contrasts
contrasts <- expand.grid(org_combo = c('11','12','13','14','15','22','23','24','25',
                                       '33','34','35','44','45','55'),
                         alt_combo = c('11','12','13','14','15','22','23','24','25',
                                       '33','34','35','44','45','55')) %>% 
  filter(org_combo != alt_combo) %>% 
  separate(org_combo, into = c('org_min', 'org_max'),
           remove = F, sep = 1) %>% 
  separate(alt_combo, into = c('alt_min', 'alt_max'),
           remove = F, sep = 1) %>% 
  mutate(org_min = as.numeric(org_min),
         org_max = as.numeric(org_max),
         alt_min = as.numeric(alt_min),
         alt_max = as.numeric(alt_max)) %>% 
  mutate(min_change = alt_min - org_min,
         max_change = alt_max - org_max) %>% 
  filter(min_change >= 0,
         max_change >= 0) %>% 
  mutate(org_min_lwr = ifelse(org_min == 1, 10,
                              ifelse(org_min == 2, 15,
                                     ifelse(org_min == 3, 20,
                                            ifelse(org_min == 4, 25,
                                                   40)))),
         org_max_lwr = ifelse(org_max == 1, 10,
                              ifelse(org_max == 2, 15,
                                     ifelse(org_max == 3, 20,
                                            ifelse(org_max == 4, 25,
                                                   40)))),
...
for(i in 1:nrow(contrasts)){
  contrast_matrix <- predictions_full[[as.numeric(as.character(contrasts$alt_combo[i]))]] - predictions_full[[as.numeric(as.character(contrasts$org_combo[i]))]]
...
## add progress marker
print('contrasts data frame filled')

## extract original values
sim_min  # original (true) slope value
mean(contrasts$mean_per_year[contrasts$min_change > 0 & contrasts$max_change == 0], na.rm = T)

sim_max  # original (true) slope value
mean(contrasts$mean_per_year[contrasts$max_change > 0 & contrasts$min_change == 0], na.rm = T)
...
contrasts <- contrasts %>% 
                              ...
                              ifelse(org_min == 2, '15-19',
                                     ifelse(org_min == 3, '20-25',
                                            ifelse(org_min == 4, '25-40',
                                                   '40+')))),
         org_max_cat = ifelse(org_max == 1, '10-15',
  ...
  mutate(org_min_cat = factor(org_min_cat,
                              levels = c('10-15','15-19','20-25',
                                         '25-40','40+')),
         org_max_cat = factor(org_max_cat,
                              levels = c('10-15','15-19','20-25',
                                         '25-40','40+')),
         ...
         alt_max_cat = factor(alt_max_cat,
                              levels = c('10-15','15-19','20-25',
                                         '25-40','40+')))
(min_plot <- ggplot(data = contrasts[contrasts$min_change > 0 & contrasts$max_change == 0,])+
    ...
    labs(x = 'original minimum age category',
         ...
         fill = 'contrast in\nlogit(probability\nof associating)'))
(max_plot <- ggplot(data = contrasts[contrasts$max_change > 0 & contrasts$min_change == 0,])+
