...
# save.image('step5_dyadicregression/anp_dyadic_simulation_diffmean_noncentredsigma_newpriors.RData')
# 
# #### plot raw data ####
# ggplot()+
...
# dev.off()
pdf('step5_dyadicregression/simulate_dyadic_anp_diff_noncentredsigma_newpriors.pdf')
...
save.image('step5_dyadicregression/anp_dyadic_simulation_agediff_noncentredsigma_newpriors.RData')

#### fit dyadic regression ####
#load('step5_dyadicregression/anp_dyadic_simulation_agediff_noncentredsigma_newpriors.RData')
...
dyadic_regression <- stan_model('models/dyadic_regression_anp_agediff_noncentredsigma_newpriors.stan')
...
for (i in 1:100) {
  ...
  mu_plot <- matrix(NA, ncol = n_dyads, nrow = n_chains) # SHOULD THIS BE N_DATA INSETAD OF N_DYADS??
