...
save.image('step5_dyadicregression/anp_dyadic_simulation_diffmean_partialpool.RData')
...
dev.off()
pdf('step5_dyadicregression/simulate_dyadic_anp_diff_partialpool.pdf')
...
save.image('step5_dyadicregression/anp_dyadic_simulation_agediff_partialpool.RData')

#### fit dyadic regression ####
#load('step5_dyadicregression/anp_dyadic_simulation_agediff_partialpool.RData')
