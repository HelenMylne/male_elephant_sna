...
pred_data <- sim[order(sim$age_cat),] # ordered because otherwise a later plotting function was being super annoying about forming logical lines and which bits it connected
