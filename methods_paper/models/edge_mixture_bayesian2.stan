...
model {
  ...
  for(dyad in 1:n_dyads){
    ...
    count_together[dyad] ~ zero_inflated_binomial(total_sightings[dyad], prob_together, edge_weight[dyad]); /*hypothetical_together ~ binomial(total_sightings, edge_weight);*/ // not convinced I've understood this function correctly??
